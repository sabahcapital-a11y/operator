 ...
 *
 * Takes a batch scan results JSON file and produces a professional,
 * self-contained HTML report that an agency owner can forward to
 * their clients or resell.
 *
 * Usage:
...
function generateReportHtml(data: BatchScanOutput, agencyName: string): string {
  ...
  const topIssueList = topIssues(data);
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .monitoring-cta .cta-line a {
    color: #fbbf24;
    text-decoration: none;
    border-bottom: 1px solid rgba(251,191,36,0.4);
  }
  .monitoring-cta .cta-line a:hover {
    color: #fcd34d;
  }
...
<div class="monitoring-cta">
  ...
  <div class="cta-line">
    → $199/month for up to 20 sites. Nightly checks. White-labeled reports.<br>
    → Reply to this report or email
    <a href="mailto:hello@silentbreak.dev">hello@silentbreak.dev</a>
    to start monitoring.
  </div>
</div>
